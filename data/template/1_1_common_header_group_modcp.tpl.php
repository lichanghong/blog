...
0
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/header_common.htm', 1492071647, '1', './data/template/1_1_common_header_group_modcp.tpl.php', './template/default', 'common/header_group_modcp')
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/header_qmenu.htm', 1492071647, '1', './data/template/1_1_common_header_group_modcp.tpl.php', './template/default', 'common/header_group_modcp')
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/pubsearchform.htm', 1492071647, '1', './data/template/1_1_common_header_group_modcp.tpl.php', './template/default', 'common/header_group_modcp')
;?>
