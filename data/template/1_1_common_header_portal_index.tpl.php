...
0
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/header_common.htm', 1492071631, '1', './data/template/1_1_common_header_portal_index.tpl.php', './template/default', 'common/header_portal_index')
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/header_qmenu.htm', 1492071631, '1', './data/template/1_1_common_header_portal_index.tpl.php', './template/default', 'common/header_portal_index')
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/pubsearchform.htm', 1492071631, '1', './data/template/1_1_common_header_portal_index.tpl.php', './template/default', 'common/header_portal_index')
;?>
